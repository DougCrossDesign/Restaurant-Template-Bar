...
class BlogCategory extends BaseModel
{
     ...
     * @var string
     */
    protected $table = "cms_core_module_blogpost_categories";
    ...
    public function posts(){
        return $this->manyToMany("\Model\Blog\BlogPost", "cms_core_module_blogposts_to_categories", "blogcategory_id", "blogpost_id", "id");
    }
}