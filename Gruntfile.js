...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		concat: {
			...
			bodyjs: {
				src: ['<%= globalConfig.src  %>/assets/js/jquery.js', '<%= globalConfig.src  %>/assets/js/jquery-ui.min.js', '<%= globalConfig.src  %>/assets/js/plugins/*.js', '<%= globalConfig.src  %>/partials/*/*.js', '<%= globalConfig.src  %>/assets/js/init.js'],
