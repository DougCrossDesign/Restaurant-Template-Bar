...
<head>
	...
	<script src="/<?php print('themes/' . config()->theme . '/assets/js/head.js'); ?>" async></script>
	<link rel="stylesheet" href="/<?php print('themes/' . config()->theme.'/assets/dropzone.css'); ?>">
	<link rel="stylesheet" href="/<?php print('themes/' . config()->theme.'/assets/style.css'); ?>">
