 ...
 */
class Eventtypes extends AdminController {

    /** @var string The name of the controller in lower case; used for urls */
    protected $controllerName = "eventtypes";

    /** @var string The name of the directory the templates are in */
    protected $templateDir = "eventtypes";

    /** @var string The name of the Model  */
    protected $modelName = "Eventtype";
    ...
    protected $modelNameSingular = "Event Type";
    protected $modelNamePlural = "Event Types";
